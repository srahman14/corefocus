        ...
        <div className="p-4 md:p-6 lg:p-8 space-y-6">
            <div className="flex flex-col lg:flex-row gap-6">
                <div className="w-full lg:w-1/2">
                    <p>Graph content of weekly habits completed and focus sessions, shuold be a toggle or dropdown to view focus sessions or habits</p>
                </div>
                <div className="w-full lg:w-1/2">
                    <p>You completed the most habits consistently on this day Name_of_Day</p>
                </div>
            </div>
