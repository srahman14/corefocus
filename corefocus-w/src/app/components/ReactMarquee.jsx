...
const cards = [
  {
    ...
    icon: <i className="fa-solid fa-bell h-[16px] w-[16px] text-[#520dd0]" />,
  },
  {
    title: "GoalBoard",
  ...
  // },
  {
    ...
    icon: <i className="fa-solid fa-pen-to-square h-[16px] w-[16px] text-[#520dd0]" />,
  },
  {
    title: "FocusCamp",
    description: "Use a goal-based timer to stay focused during Qur’an study, workouts, or deep work.",
    icon: <i className="fa-solid fa-stopwatch h-[16px] w-[16px] text-[#520dd0]" />,
  },
];

export default function ImageMarquee() {
  return (
    <Marquee gradient={true} gradientColor="black" speed={35} className="rounded-xl">
