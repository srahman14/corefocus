          ...
          <div className="flex items-center justify-center text-center flex-row gap-30">
            <div className="p-17 rounded-lg"       
              ...
              <div className="flex mt-30 x-space-4 justify-start">
                  <Link href="/signup" className="bg-[#222] text-white mr-4 hover:bg-[#222]/90 p-5 rounded-4xl font-semibold tracking-tighter text-xl md:text-2xl">Get Started</Link>
                  <Link href="/" className="bg-[#222] text-white hover:bg-[#222]/90 p-5 rounded-4xl font-semibold tracking-tighter text-xl md:text-2xl">Explore Plans</Link>
              </div>

            </div>
            <img src="/asset_6.png" className="hidden lg:block w-[30rem] h-[30rem] rounded-3xl"></img>
          </div>
        </AnimatedContent>
      ...
      <section className="container flex flex-col justify-center">
          ...
          >
            ...
            <div className="flex flex-row flex-wrap justify-center items-center p-3 m-20 mt-10"> 
              ...
              <SpotlightCard className="custom-spotlight-card m-10 sm:min-h-85 sm:w-82 md:w-75 lg:min-h-100 lg:w-92 text-center cursor-default text-white flex flex-col items-center justify-center" spotlightColor="rgba(234, 230, 238, 0.2)">
